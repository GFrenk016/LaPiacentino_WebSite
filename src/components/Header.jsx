...
export default function Header() {
    ...
    return (
        <header className="w-full border-b border-slate-200 bg-white/80 backdrop-blur sticky top-0">
            <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 md:py-4">
                ...
                {/* Desktop nav */}
                <nav className="hidden items-center gap-6 text-sm font-medium colorSec md:flex">
                {navLinks.map((link) => (
                    <a
                    key={link.href}
                    href={link.href}
                ...
                <a
                    href="#cta"
                    className="rounded-full bgPrim px-4 py-2 text-sm font-semibold text-white shadow-sm transition"
                >
                    Inizia ora
                </a>
                </nav>
